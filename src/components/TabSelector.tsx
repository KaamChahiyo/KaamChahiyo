...
export const TabSelector = ({
  ...
  <div className="container">
    <div
      className={`hidden group lg:flex w-5/6 p-2 gap-0 lg:gap-5 rounded-md cursor-pointer ${
        isActive
    ...
    <button
      className={`mr-8 lg:hidden group inline-flex items-center px-2 py-4 border-b-2 font-medium text-sm leading-5 cursor-pointer whitespace-nowrap ${
        isActive
