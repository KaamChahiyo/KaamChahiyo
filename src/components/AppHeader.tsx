...
export default function AppHeader() {
    ...
    return (
        <div className="mb-24">
            <nav className={classNames("z-50 flex w-full fixed justify-between bg-white lg:py-4 gap-20  items-center h-24 overflow-visible", {
                ...
                <div className="flex justify-between w-full items-center container mx-auto">
                    ...
                    >
                        <div className="w-6 text-primary-0">
                            {MenuIcon}
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        <div className="bg-white  min-h-screen w-8/12 flex flex-col align-top overflow-hidden justify-start p-6" >
                            ...
                            {
                                menu.map((menuName) =>
                                    <div className="text-gray-400 font-medium text-xs mt-2" key={menuName.menuLabel}>
