...
const AllServices = ({
  ...
  return (
    <Link passHref href={link} className="flex gap-10">
      <div className="flex flex-row w-auto gap-5 shadow border border-gray-200 hover:border-cyan-600  rounded-lg overflow-hidden p-5 bg-slate-50 hover:scale-110  items-center">
