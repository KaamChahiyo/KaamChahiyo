                                ...
                                <div className="p-10">
                                    <div className='flex flex-col gap-3 p-10 bg-white shadow-md rounded-3xl h-[672px]'>
                                        ...
                                        <div className='flex flex-col gap-1 text-gray-500'>
                                            ...
                                            <input type="password" placeholder="Enter current Password" value=""
                                                className='border-2 focus:outline-none border-gray-300 p-3 rounded-md'
                                            />
                                        </div>
                                        <div className='flex flex-col gap-1 text-gray-500'>
                                            <label>New password:</label>
                                            <input type="password" placeholder="Type new password" value=""
                                                className='border-2 focus:outline-none border-gray-300 p-3 rounded-md'
                                            />
                                        </div>
                                        <div className='flex flex-col gap-1 text-gray-500'>
                                            <label>Retype new password:</label>
                                            <input type="password" placeholder="Re-type password" value=""
                                                className='border-2 focus:outline-none border-gray-300 p-3 rounded-md'
                                            />
                                        </div>
