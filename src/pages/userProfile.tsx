...
export default function Profile() {
    ...
    const imageChange = (e) => { setUserImage(e.target.value) }
                            ...
                            <div className='flex flex-col gap-3 p-10 bg-white shadow-md rounded-3xl h-[672px]'>
                                ...
                                <div className='flex flex-col'>
                                    <div className='w-20 h-20'>
                                        <Image src={userImage} alt={userName} width={100} height={100} quality={100} />
                                    </div>
                                    <div>{userName}</div>
                                </div>
                                ...
                                <div className='flex flex-col gap-1 text-gray-500'>
                                    <label>Bio:</label>
                                    <textarea rows={3} value={userBio} placeholder={userBio} onChange={bioChange}
